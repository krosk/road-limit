  ...
  for (const feature of features) {
    ...
    for (let i = 0; i < coords.length - 1; i++) {
      ...
      if (d < bestDist) {
        ...
        // Oneway features must always be walked in coordinate order — never contra-flow.
        // firstTurnAhead will filter the segment if it points away from the car's heading.
